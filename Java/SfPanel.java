package com.appbuilders.quienesestepoke.libraries.Surface;
...
import com.appbuilders.quienesestepoke.libraries.Surface.Core.SfBox;
import com.appbuilders.quienesestepoke.libraries.Surface.Core.SfPoint;
import com.appbuilders.quienesestepoke.libraries.Surface.Core.SfRect;
import com.appbuilders.quienesestepoke.libraries.Surface.Core.SfSize;
...
public class SfPanel extends Object {
    ...
    public SfPanel update(Context context) {
        ...
        if ( this.scrollHost && this.fixScroll ) {
            int cachito = (int)( this.frame.height * new Screen(context).getDpY(300) ) / 2560;
